...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_GRPC_HEADER_ENCODE_E */ {"grpc", EC_NET, EF_DROP_SIMPLE_CONS | EF_NONE_PARSE, 7, {{"streamid", PT_UINT64, PF_DEC}, {"fd", PT_UINT64, PF_DEC}, {"status", PT_CHARBUF, PF_NA}, {"grpc_status", PT_CHARBUF, PF_NA}, {"scheme", PT_CHARBUF, PF_NA}, {"authority", PT_CHARBUF, PF_NA}, {"path", PT_CHARBUF, PF_NA}}}
