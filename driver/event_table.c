...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_GRPC_HEADER_ENCODE_E */ {"grpc_header_encoder", EC_NET, EF_USES_FD | EF_READS_FROM_FD | EF_DROP_SIMPLE_CONS, 8, {{"streamid", PT_UINT32, PF_DEC}, {"fd", PT_INT32, PF_DEC}, {"end_stream", PT_UINT32, PF_DEC}, {"status", PT_CHARBUF, PF_NA}, {"grpc_status", PT_CHARBUF, PF_NA}, {"scheme", PT_CHARBUF, PF_NA}, {"authority", PT_CHARBUF, PF_NA}, {"path", PT_CHARBUF, PF_NA}}},
	/* PPME_GRPC_HEADER_ENCODE_X */ {"grpc_header_encoder", EC_NET, EF_USES_FD | EF_READS_FROM_FD | EF_DROP_SIMPLE_CONS, 0},
